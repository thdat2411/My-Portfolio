...
<div class="albums">
    <h1> Downloads</h1>
    <h2>Charlie Puth - Voice Notes</h2>
    <div class="voice-chat-card">
        <div class="voice-chat-card-header">
            <div class="username">Attention</div>
            <div class="status"></div>
        </div>
        <div class="voice-chat-card-body">
            <div class="audio-container">
                <audio controls>
                    <source type="audio/mpeg" src="../Task2/musicstore/${productCode}/Attention.mp3">
    ...
    <div class="voice-chat-card">
        <div class="voice-chat-card-header">
            <div class="username">How long</div>
            <div class="status"></div>
        </div>
        <div class="voice-chat-card-body">
            <div class="audio-container">
                <audio controls>
                    <source type="audio/mpeg" src="../Task2/musicstore/${productCode}/How_long.mp3">
                    Your browser does not support the audio element.
                </audio>
            </div>
        </div>
